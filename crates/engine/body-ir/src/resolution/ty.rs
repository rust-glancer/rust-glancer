...
pub(super) type TypeSubst = IndexedTypeSubst;
...
pub(super) fn local_type_subst(body: &BodyData, ty: &IndexedLocalNominalTy) -> TypeSubst {
...
pub(super) fn substitute_type_param(path: &Path, subst: &TypeSubst) -> Option<IndexedTy> {
