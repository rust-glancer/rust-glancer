...
pub use self::{
    ...
    ir::{
        ...
        ExprData, ExprId, ExprKind, LabelData, LiteralKind, PackageBodies, PatBindingMode, PatData,
        PatId, PatKind, PatMutability, PatRangeKind, RecordExprField, RecordPatField,
