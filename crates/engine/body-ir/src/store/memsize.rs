use crate::{
    ...
    BodyRef, BodyRefMutability, BodyResolution, BodySelfParamKind, BodySignedIntTy, BodySource,
    BodyTy, BodyTypePathResolution, BodyUnsignedIntTy, BodyValueItemData, BodyValueItemDeclaration,
