            ...
            expr e2 block s1 => i32 @ 10:24-12:2
              tail
                expr e1 call => i32 @ 11:5-11:19
                  callee
                    expr e0 path $crate::dep_value -> fn dep[lib]::crate::dep_value => function item fn dep[lib]::crate::dep_value @ 11:5-11:19
            ...
            expr e2 block s1 => i32 @ 14:32-16:2
              tail
                expr e1 call => i32 @ 15:5-15:26
                  callee
                    expr e0 path $crate::dep_value -> fn dep[lib]::crate::dep_value => function item fn dep[lib]::crate::dep_value @ 15:5-15:26
