...
#[test]
fn lowers_annotated_destructured_and_unannotated_closure_params() {
...
"#,
        expect![[r#"
            ...
            body b0 fn body_closure_fixture[lib]::crate::use_it @ 3:1-8:2
            scopes
            - s0 parent <none>: v0
            - s1 parent s0: v2, v5, v7
            - s2 parent s1: v1
            - s3 parent s2: <none>
            - s4 parent s1: v3, v4
            - s5 parent s1: v6
            ...
            - v6 param user `user` => <unknown> @ 6:17-6:21
            - v7 let echo `echo` => closure #6 @ 6:9-6:13
            body
            expr e8 block s1 => nominal struct body_closure_fixture[lib]::crate::User @ 3:35-8:2
              ...
              stmt s2 let v7 @ 6:5-6:28
                initializer
                  expr e6 closure s5 (v6) => closure #6 @ 6:16-6:27
                    body
                      expr e5 path user -> local v6 => <unknown> @ 6:23-6:27
              tail
                expr e7 path user -> local v0 => nominal struct body_closure_fixture[lib]::crate::User @ 7:5-7:9
        "#]],
    );
}
