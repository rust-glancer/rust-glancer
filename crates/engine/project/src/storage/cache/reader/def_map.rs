...
use crate::{
    profile::metric,
    storage::cache::{PackageCacheCodec, codec::CRATE_SHARD_CONTAINER_PREFIX_BYTES},
};
...
impl PackageArtifactReader {
    ...
    fn def_map_index(
        &self,
    ) -> Result<&crate::storage::cache::codec::PackageDefMapCacheIndex, PackageCacheReadError> {
