...
///
/// Saved readers and prepared current declarations stay frozen for the request. Filling item
/// lookup caches never changes which declarations or bodies are visible through this handle.
#[derive(Debug, Clone)]
