...
use rg_ir_view::lookup::name::NameOrigin;
...
pub(crate) enum CompletionSortPolicy {
    /// Label-first ordering for expressions, members, imports, and other general sites.
    General,
    /// Prefer concrete type-shaped candidates before applying ordinary label ordering.
    TypePosition,
}
