...
pub(super) fn print_allocator_stats(stats: rg_lsp_server::AllocatorStats) {
    println!(
...
pub(super) struct AllocatorPurgeReport {
    result: rg_lsp_server::AllocatorPurgeResult,
    before: Option<rg_lsp_server::AllocatorStats>,
    after: Option<rg_lsp_server::AllocatorStats>,
}

pub(super) fn purge_allocator_after_build(
    memory_control: &dyn rg_lsp_server::MemoryControl,
