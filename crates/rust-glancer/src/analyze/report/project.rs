    ...
    pub(crate) fn capture(project: &Project) -> Self {
        ...
        Self {
            ...
            body_ir: BodyIrReport {
                ...
                local_item_count: stats.body_ir.local_item_count,
                local_impl_count: stats.body_ir.local_impl_count,
                local_function_count: stats.body_ir.local_function_count,
...
pub(crate) struct BodyIrReport {
    ...
    pub(crate) local_impl_count: usize,
    pub(crate) local_function_count: usize,
