...
#[doc(hidden)]
#[macro_export]
macro_rules! __rg_std_record_memory_fields {
    ($recorder:expr, $owner:expr, $($(#[$field_attr:meta])* $field:ident),+ $(,)?) => {
        $(
            $(#[$field_attr])*
            {
                $recorder.scope(stringify!($field), |recorder| {
                    $crate::memsize::MemorySize::record_memory_children(&$owner.$field, recorder);
                });
            }
        )+
    };
...
///
/// ```
/// # use rg_std::memsize::{MemoryRecorder, MemorySize, record_memory_fields};
...
/// # }
/// ```
pub use crate::__rg_std_record_memory_fields as record_memory_fields;

#[doc(hidden)]
#[macro_export]
macro_rules! __rg_std_impl_memory_size_children {
    ($($ty:ty => $($(#[$field_attr:meta])* $field:ident),+ $(,)?);+ $(;)?) => {
        $(
            impl $crate::memsize::MemorySize for $ty {
                fn record_memory_children(&self, recorder: &mut $crate::memsize::MemoryRecorder) {
                    $crate::memsize::record_memory_fields!(
                        recorder,
                        self,
                        $($(#[$field_attr])* $field),+
                    );
...
///
/// ```
/// # use rg_std::memsize::{MemorySize, impl_memory_size_children};
/// # struct Package { files: Vec<String>, target_roots: Vec<String> }
...
/// }
/// ```
pub use crate::__rg_std_impl_memory_size_children as impl_memory_size_children;

#[doc(hidden)]
#[macro_export]
macro_rules! __rg_std_impl_memory_size_leaf {
    ($($ty:ty),+ $(,)?) => {
        $(
            impl $crate::memsize::MemorySize for $ty {
                fn record_memory_children(&self, _recorder: &mut $crate::memsize::MemoryRecorder) {}
            }
        )+
    };
}
...
pub use crate::__rg_std_impl_memory_size_leaf as impl_memory_size_leaf;
